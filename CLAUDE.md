...
ottl is an **ultra-lean CLI wrapper** around the official OpenTelemetry Transformation Language (OTTL) library.
This project demonstrates exceptional engineering by achieving a **175-line single-file implementation** that
provides complete OTTL functionality.
...
parser, err := ottlspan.NewParser(ottlfuncs.StandardFuncs[ottlspan.TransformContext](), 
...
This project is a **reference implementation** of how to build effective, simple tools that solve real
